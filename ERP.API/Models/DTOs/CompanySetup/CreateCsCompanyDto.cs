...
{
    public class CreateCsCompanyDto
    {
        ...
        public DateTime FinancialYearStartDate { get; set; } = DateTime.Now.Date;

        public DateTime FinancialYearEndDate { get; set; } = DateTime.Now.Date.AddYears(1).AddDays(-1);
